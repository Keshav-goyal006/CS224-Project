...
always @(*) begin
	...
	case (instruction_i[`OPCODE])
    	...
    	BRANCH: immediate = {{19{instruction_i[31]}},instruction_i[31],instruction_i[7],instruction_i[30:25],instruction_i[11:8],1'b0};// TODO: assemble bits exactly as specified above
    	...
    	JAL   : immediate = {{11{instruction_i[31]}},instruction_i[31],instruction_i[19:12],instruction_i[20],instruction_i[30:21],1'b0};// TODO: assemble bits exactly as specified above
...
id_ex_reg u_id_ex (
	...
	.alu_i ( (instruction_i[`OPCODE] == ARITHR) || (instruction_i[`OPCODE] == ARITHI) ),
	.lui_i      	(instruction_i[`OPCODE] == LUI),
	.jal_i      	(/* TODO: If instruction opcode is JAL*/instruction_i[`OPCODE] == JAL),
	.jalr_i     	(instruction_i[`OPCODE] == JALR),
	.branch_i   	(/* TODO: If instruction opcode is BRANCH*/instruction_i[`OPCODE] == BRANCH),
